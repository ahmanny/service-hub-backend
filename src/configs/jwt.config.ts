...
export const configs: TJwtConfig = {
    ...
    access_token_expiration_time: env.get('JWT_ACCESS_TOKEN_EXPIRATION_TIME').asString() || '3h',
    verify_token_secret_key: env.get('JWT_VERIFY_TOKEN_SECRET').asString() || 'fallback_secret_for_dev',
};
